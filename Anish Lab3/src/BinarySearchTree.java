...
public class BinarySearchTree<E> extends AbstractSet<E> implements Serializable {
     ...
     *                              elements already in this BinarySearchTree
     *                              object.
    ...
    protected class TreeIterator implements Iterator<E> {
        ...
        /**
         * Determines if there are still some elements, in the BinarySearchTree object
         * this
         * TreeIterator object is iterating over, that have not been accessed by this
         * TreeIterator object.
         *
         * @return true - if there are still some elements that have not been accessed
         *         by
         ...
         * The worstTime(n) is O(n) and averageTime(n) is constant.
         *
         * @return the element this TreeIterator object was positioned at before this
         *         call.
         *
         ...
         *                               TreeIterator�s remove() method was
         *                               called between the call to the next() method
         *                               and this call.
         *
         */
        public void remove() {
